...
func validateGardener(gardener operatorv1alpha1.Gardener, kubernetes operatorv1alpha1.Kubernetes, fldPath *field.Path) field.ErrorList {
	...
	allErrs = append(allErrs, validateGardenerAPIServerConfig(gardener.APIServer, kubernetes.KubeAPIServer, fldPath.Child("gardenerAPIServer"))...)
...
func validateGardenerAPIServerConfig(config *operatorv1alpha1.GardenerAPIServerConfig, kubeAPIServerConfig *operatorv1alpha1.KubeAPIServerConfig, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
